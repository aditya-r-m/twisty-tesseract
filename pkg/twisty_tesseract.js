...
export class Tesseract {
    ...
    input(s) {
        ...
        wasm.tesseract_input(this.__wbg_ptr, ptr0, len0);
    }
    tick() {
        wasm.tesseract_tick(this.__wbg_ptr);
    }
    /**
     * @param {number} b
     * @param {number} s
    ...
    project(b, s) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.tesseract_project(this.__wbg_ptr, b, s);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('twisty_tesseract_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
